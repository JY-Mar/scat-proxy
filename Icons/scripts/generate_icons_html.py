...
html = [
    ...
    ".group > .icon-wrapper:has(.icon-item:hover) { width: unset !important; height: unset !important; }",
    ...
    ".group > .icon-wrapper > .icon-item:hover + .icon-tip { margin-top: 1.25rem; font-size: 1rem; position: absolute; background-color: #666666; border-bottom-left-radius: 6px; border-bottom-right-radius: 6px; }",
    ".group > .icon-wrapper > .icon-item:hover.large + .icon-tip { width: calc(144px * 1.2); left: calc((144px + 10px * 2) * -0.2 / 2); bottom: -1.7rem; }",
    ".group > .icon-wrapper > .icon-item:hover.medium + .icon-tip { width: calc(96px * 1.2); left: calc((96px + 10px * 2) * -0.2 / 2); bottom: -1.5rem; }",
    ".group > .icon-wrapper > .icon-item:hover.small + .icon-tip { width: calc(64px * 1.2); left: calc((64px + 10px * 2) * -0.2 / 2); bottom: -1.3rem; }",
    ...
    ".group > .icon-wrapper > .icon-tip { width: 100%; text-align: center; font-size: 0.875rem; white-space: nowrap; overflow: hidden; text-overflow: ellipsis; margin-top: 5px; will-change: bottom,font-size,background-color; transition: bottom 0.25s ease, font-size 0.25s ease, background-color 0.25s ease; }",
    "</style>",
    "</head>",
    "<body>",
