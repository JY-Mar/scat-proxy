...
html = [
    ...
    ".group > .icon-wrapper > .icon-item:hover.large + .icon-tip { width: calc(144px * 1.2); left: calc(144px * -0.2 / 2); bottom: -1.2rem; }",
    ".group > .icon-wrapper > .icon-item:hover.medium + .icon-tip { width: calc(96px * 1.2); left: calc(96px * -0.2 / 2); bottom: -1rem; }",
    ".group > .icon-wrapper > .icon-item:hover.small + .icon-tip { width: calc(64px * 1.2); left: calc(64px * -0.2 / 2); bottom: -0.8rem; }",
