...
html = [
    ...
    ".group > .icon-wrapper > .icon-item:hover.large + .icon-tip { width: calc((144px + 10px * 2) * 1.2); left: calc((144px + 10px * 2) * -0.2 / 2); bottom: -1.7rem; }",
    ".group > .icon-wrapper > .icon-item:hover.medium + .icon-tip { width: calc((96px + 10px * 2) * 1.2); left: calc((96px + 10px * 2) * -0.2 / 2); bottom: -1.5rem; }",
    ".group > .icon-wrapper > .icon-item:hover.small + .icon-tip { width: calc((64px + 10px * 2) * 1.2); left: calc((64px + 10px * 2) * -0.2 / 2); bottom: -1.3rem; }",
