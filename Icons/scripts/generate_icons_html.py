...
html = [
    ...
    ".group > .icon-wrapper > .icon-item:hover.large + .icon-tip { width: calc(144px * 1.2); }",
    ".group > .icon-wrapper > .icon-item:hover.medium + .icon-tip { width: calc(96px * 1.2); }",
    ".group > .icon-wrapper > .icon-item:hover.small + .icon-tip { width: calc(64px * 1.2); }",
