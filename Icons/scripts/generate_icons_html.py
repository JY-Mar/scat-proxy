...
html = [
    ...
    ".group > .icon-wrapper > .icon-item:hover.large + .icon-tip { left: 0; bottom: calc(-144px * 0.2 + 1px); }",
    ".group > .icon-wrapper > .icon-item:hover.medium + .icon-tip { left: 0; bottom: calc(-96px * 0.2 + 1px); }",
    ".group > .icon-wrapper > .icon-item:hover.small + .icon-tip { left: 0; bottom: calc(-64px * 0.2 + 1px); }",
