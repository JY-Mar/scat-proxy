...
html = [
    ...
    ".group > .icon-wrapper > .icon-item:hover.medium + .icon-tip { width: calc((96px) * 1.2); left: calc((96px + 10px * 2) * -0.2 / 2); bottom: calc(-1.5rem + 1px); }",
    ".group > .icon-wrapper > .icon-item:hover.small + .icon-tip { width: calc((64px) * 1.2); left: calc((64px + 10px * 2) * -0.2 / 2); bottom: calc(-1.3rem + 1px); }",
